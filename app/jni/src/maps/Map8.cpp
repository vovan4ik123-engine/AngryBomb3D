...
{
    Map8::Map8(std::shared_ptr<PlayStateGUILayer> gui) : BaseMap(std::move(gui))
    {
        loadPlayer();
        loadEnv();
        loadEnemies();
        loadPlayerPoints();
        loadBulletSet(BulletType::STANDARD_1_KG, 2, 1.0f);
    ...
    void Map8::loadEnv()
    {
        ...
        auto staticEnv = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map8/Static_0_5friction.fbx",
                                                                                              0.0f,
                                                                                              false,
                                                                                              Beryll::CollisionFlags::STATIC,
                                                                                              Beryll::CollisionGroups::STATIC_ENVIRONMENT,
        ...
        auto dynamicEnv1 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map8/Dynamic_1kg_0_5friction.fbx",
                                                                                  1.0f,
                                                                                  false,
        ...
        auto dynamicEnv2 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map8/Dynamic_10kg_0_5friction.fbx",
                                                                                    10.0f,
                                                                                    false,
                                                                                    Beryll::CollisionFlags::DYNAMIC,
                                                                                    Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
    ...
    void Map8::loadEnemies()
    {
        auto enemies = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map8/Enemies.fbx",
                                                                                1.0f,
                                                                                true,
                                                                                Beryll::CollisionFlags::DYNAMIC,
                                                                                Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
    ...
    void Map8::loadPlayerPoints()
    {
        auto points = Beryll::SimpleObject::loadManyModelsFromOneFile("models3D/map8/PlayerPoints.fbx", Beryll::SceneObjectGroups::GROUND);
