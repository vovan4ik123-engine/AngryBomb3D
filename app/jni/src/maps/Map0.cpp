...
{
    Map0::Map0(std::shared_ptr<PlayStateGUILayer> gui) : BaseMap(std::move(gui))
    {
        loadPlayer();
        loadEnv();
        loadEnemies();
    ...
    void Map0::loadEnv()
    {
        auto ground = std::make_shared<Beryll::SimpleCollidingObject>("models3D/mapCommon/Ground_800.fbx",
                                                                                     0.0f,
                                                                                     false,
        ...
        auto staticEnv = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map0/Static_0_5friction.fbx",
                                                                                  0.0f,
                                                                                  false,
                                                                                  Beryll::CollisionFlags::STATIC,
                                                                                  Beryll::CollisionGroups::STATIC_ENVIRONMENT,
        ...
        auto dynamicEnv1 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map0/Dynamic_1kg_0_5friction.fbx",
                                                                                  1.0f,
                                                                                  false,
    ...
    void Map0::loadEnemies()
    {
//        auto enemies = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map0/Enemies.fbx",
//                                                                                1.0f,
//                                                                                true,
//                                                                                Beryll::CollisionFlags::DYNAMIC,
//                                                                                Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
...
//        }
    ...
    void Map0::loadPlayerPoints()
    {
        auto points = Beryll::SimpleObject::loadManyModelsFromOneFile("models3D/map0/PlayerPoints.fbx", Beryll::SceneObjectGroups::GROUND);
