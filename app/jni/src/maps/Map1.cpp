...
namespace AngryBomb3D
{
    ...
    void Map1::loadEnv()
    {
        ...
        auto staticEnv = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map1/Static_1friction.fbx",
                                                                                  0.0f,
                                                                                  false,
                                                                                  Beryll::CollisionFlags::STATIC,
                                                                                  Beryll::CollisionGroups::STATIC_ENVIRONMENT,
        ...
        auto dynamicEnv1 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map1/Dynamic_1kg_0_5friction.fbx",
                                                                                  1.0f,
                                                                                  false,
        ...
        auto dynamicEnv2 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map1/Dynamic_1kg_1friction.fbx",
                                                                                    1.0f,
                                                                                    false,
                                                                                    Beryll::CollisionFlags::DYNAMIC,
                                                                                    Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
