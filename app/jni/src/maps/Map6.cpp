...
{
    Map6::Map6(std::shared_ptr<PlayStateGUILayer> gui) : BaseMap(std::move(gui))
    {
        loadPlayer();
        loadEnv();
        loadEnemies();
        ...
        m_dirToSun = glm::normalize(glm::vec3(-0.6f, 1.0f, -0.3f));
    ...
    void Map6::loadEnv()
    {
        ...
        auto dynamicEnv1 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map6/Dynamic_1kg_0_5friction.fbx",
                                                                                  1.0f,
                                                                                  false,
        ...
        auto dynamicEnv2 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map6/Dynamic_20kg_0_5friction.fbx",
                                                                                   20.0f,
                                                                                   false,
                                                                                   Beryll::CollisionFlags::DYNAMIC,
                                                                                   Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
    ...
    void Map6::loadEnemies()
    {
        auto enemies = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map6/Enemies.fbx",
                                                                                1.0f,
                                                                                true,
                                                                                Beryll::CollisionFlags::DYNAMIC,
                                                                                Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
    ...
    void Map6::loadPlayerPoints()
    {
        auto points = Beryll::SimpleObject::loadManyModelsFromOneFile("models3D/map6/PlayerPoints.fbx", Beryll::SceneObjectGroups::GROUND);
