...
{
    Map5::Map5(std::shared_ptr<PlayStateGUILayer> gui) : BaseMap(std::move(gui))
    {
        loadPlayer();
        loadEnv();
        loadEnemies();
    ...
    void Map5::loadEnv()
    {
        ...
        auto staticEnv = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map5/Static_0_5friction.fbx",
                                                                                              0.0f,
                                                                                              false,
                                                                                              Beryll::CollisionFlags::STATIC,
                                                                                              Beryll::CollisionGroups::STATIC_ENVIRONMENT,
        ...
        auto dynamicEnv1 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map5/Dynamic_1kg_0_5friction.fbx",
                                                                                  1.0f,
                                                                                  false,
        ...
        auto dynamicEnv2 = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map5/Dynamic_50kg_0_5friction.fbx",
                                                                                    50.0f,
                                                                                    false,
                                                                                    Beryll::CollisionFlags::DYNAMIC,
                                                                                    Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
    ...
    {
        auto enemies = Beryll::SimpleCollidingObject::loadManyModelsFromOneFile("models3D/map5/Enemies.fbx",
                                                                                1.0f,
                                                                                true,
                                                                                Beryll::CollisionFlags::DYNAMIC,
                                                                                Beryll::CollisionGroups::DYNAMIC_ENVIRONMENT,
    ...
    void Map5::loadPlayerPoints()
    {
        auto points = Beryll::SimpleObject::loadManyModelsFromOneFile("models3D/map5/PlayerPoints.fbx", Beryll::SceneObjectGroups::GROUND);
